...
class Auth extends AuthConfig
{
	...
	/**
	 * --------------------------------------------------------------------
	 * Additional Fields for users data
	 * --------------------------------------------------------------------
	 *
	 * For example:
	 *	 $optionalFields = ['photo', 'nickname'];
	 *
	 * @var string[]
	 */
	public $optionalFields = ['jenis_kelamin'];
	...
	public $userActivators = [
		'Myth\Auth\Authentication\Activators\EmailActivator' => [
			'fromEmail' => 'admin@pmiibumiayu.com',
			'fromName' => 'Admin',
		],
	];
