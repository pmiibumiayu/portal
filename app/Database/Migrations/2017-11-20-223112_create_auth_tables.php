...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'fullname'              => ['type' => 'varchar', 'constraint' => 64, 'null' => true],
            'alamat'                => ['type' => 'varchar', 'constraint' => 256, 'null' => true],
            'ttl'                   => ['type' => 'date', 'null' => true],
            'agama'                 => ['type' => 'varchar', 'constraint' => 16, 'null' => true],
            'jenis_kelamin'         => ['type' => 'ENUM', 'constraint' => ['Laki-laki', 'Perempuan'], 'default' => 'Laki-laki'],
            'prodi'                 => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
            'fakultas'              => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
            'universitas'           => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
            'no_hp'                 => ['type' => 'varchar', 'constraint' => 16, 'null' => true],
            'riwayat_pendidikan'    => ['type' => 'json', 'null' => true],
            'histori_organisasi'    => ['type' => 'json', 'null' => true],
            'kaderisasi_formal'     => ['type' => 'json', 'null' => true],
            'kaderisasi_informal'   => ['type' => 'json', 'null' => true],
            'kaderisasi_nonformal'  => ['type' => 'json', 'null' => true],
            ...
            'photo'                 => ['type' => 'varchar', 'constraint' => 128, 'null' => 0, 'default' => 'default.png'],
